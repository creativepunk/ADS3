...
} from "./chunk-BVONF64D.js";
import {
  __toESM
} from "./chunk-LK32TJAX.js";

// ../../node_modules/.pnpm/@storybook+core@8.6.18_prettier@3.8.3_storybook@8.6.18_prettier@3.8.3_/node_modules/@storybook/core/dist/theming/create.js
var import_client_logger = __toESM(require_client_logger());
var ie = Object.defineProperty;
var n = (r, e) => ie(r, "name", { value: e, configurable: true });
function v() {
...
function w(r, e, t, a) {
  ...
  i >= 0 && i < 1 ? (f = o, p = u) : i >= 1 && i < 2 ? (f = u, p = o) : i >= 2 && i < 3 ? (p = o, l = u) : i >= 3 && i < 4 ? (p = u, l = o) : i >= 4 && i < 5 ? (f = u, l = o) : i >= 5 && i < 6 && (f = o, l = u);
...
var de = /^#[a-fA-F0-9]{3}$/;
var ce = /^#[a-fA-F0-9]{4}$/;
var R = /^rgb\(\s*(\d{1,3})\s*(?:,)?\s*(\d{1,3})\s*(?:,)?\s*(\d{1,3})\s*\)$/i;
var me = /^rgb(?:a)?\(\s*(\d{1,3})\s*(?:,)?\s*(\d{1,3})\s*(?:,)?\s*(\d{1,3})\s*(?:,|\/)\s*([-+]?\d*[.]?\d+[%]?)\s*\)$/i;
var ge = /^hsl\(\s*(\d{0,3}[.]?[0-9]+(?:deg)?)\s*(?:,)?\s*(\d{1,3}[.]?[0-9]?)%\s*(?:,)?\s*(\d{1,3}[.]?[0-9]?)%\s*\)$/i;
var he = /^hsl(?:a)?\(\s*(\d{0,3}[.]?[0-9]+(?:deg)?)\s*(?:,)?\s*(\d{1,3}[.]?[0-9]?)%\s*(?:,)?\s*(\d{1,3}[.]?[0-9]?)%\s*(?:,|\/)\s*([-+]?\d*[.]?\d+[%]?)\s*\)$/i;
function $(r) {
  if (typeof r != "string")
    throw new d(3);
  var e = fe(r);
  ...
  var u = ge.exec(e);
  if (u) {
    var f = parseInt("" + u[1], 10), p = parseInt("" + u[2], 10) / 100, l = parseInt("" + u[3], 10) / 100, h = "rgb(" + w(f, p, l) + ")", b = R.exec(h);
    if (!b)
      throw new d(4, e, h);
    return {
      red: parseInt("" + b[1], 10),
  ...
  if (c) {
    var A = parseInt("" + c[1], 10), ne = parseInt("" + c[2], 10) / 100, ae = parseInt("" + c[3], 10) / 100, W = "rgb(" + w(A, ne, ae) + ")", S = R.exec(W);
    if (!S)
      throw new d(4, e, W);
    return {
      red: parseInt("" + S[1], 10),
...
var { window: H } = ee;
var Me = n((r) => typeof r != "string" ? (import_client_logger.logger.warn(
  `Color passed to theme object should be a string. Instead ${r}(${typeof r}) was passed.`
), false) : true, "isColorString");
var Pe = n((r) => !/(gradient|var|calc)/.test(r), "isValidColorForPolished");
var Ee = n(
  (r, e) => r === "darken" ? x(`${Z(1, e)}`, 0.95) : r === "lighten" ? x(`${X(1, e)}`, 0.95) : e,
  "applyPolished"
);
var re = n((r) => (e) => {
  if (!Me(e) || !Pe(e))
...
var jr = re("lighten");
var Or = re("darken");
var te = n(() => !H || !H.matchMedia ? "light" : H.matchMedia("(prefers-color-scheme: dark)").matches ? "dark" : "light", "getPreferredColorScheme");
var L = {
  light: E,
  dark: _,
  normal: E
...
//# sourceMappingURL=@storybook_theming_create.js.map
