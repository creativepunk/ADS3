 ...
 */
export declare function dispatch<K extends keyof DsEventMap>(element: HTMLElement, eventName: K, detail: DsEventMap[K]['detail'], options?: Omit<CustomEventInit, 'detail'>): boolean;
