...
const SIZES: DsIconSize[] = ['sm', 'md', 'lg'];
const STYLES: DsIconStyle[] = ['outlined', 'rounded', 'sharp'];
...
export const ShowcaseStyles: Story = {
...
export const ShowcaseFill: Story = {
  name: 'Showcase / Fill vs Outline',
  tags: ['!dev'],
  parameters: { controls: { disable: true } },
  render: () => html`
    <div style="display: flex; gap: 24px; align-items: center;">
      ${(['star', 'favorite', 'home', 'settings'] as string[]).map(
        (name) => html`
...
export const ShowcaseSwatch: Story = {
...
export const ShowcaseInContext: Story = {
