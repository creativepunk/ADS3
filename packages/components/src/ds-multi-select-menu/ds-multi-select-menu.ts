...
import type {
  ...
  DsMultiSelectMenuItemSize,
} from './ds-multi-select-menu-item.js';
...
export class DsMultiSelectMenu extends LitElement {
  static styles = [
    resetStyles,
  ...
  private _items(): DsMultiSelectMenuItem[] {
    return Array.from(
      this.querySelectorAll<DsMultiSelectMenuItem>('ds-multi-select-menu-item'),
    );
  }

  private _groups(): import('./ds-multi-select-menu-group.js').DsMultiSelectMenuGroup[] {
    return Array.from(
      this.querySelectorAll('ds-multi-select-menu-group'),
    ) as import('./ds-multi-select-menu-group.js').DsMultiSelectMenuGroup[];
  }
