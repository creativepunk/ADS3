...
export { spacing, radius, typeScale, fontFamily, fontWeight, typography, typographyCompact, } from './dimension.js';
export type { Spacing, Radius, TypeScale, FontFamily, FontWeight, Typography, TypographyCompact, } from './dimension.js';
