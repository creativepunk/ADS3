...
import {
  DsCalendar as LitDsCalendar,
  type DsCalendarMarkerColor,
  type DsCalendarMarkers,
} from '@my-ds/components/src/ds-calendar/ds-calendar.js';
import type {
  DsSelectEvent,
  DsNavigateEvent,
...
export const DsCalendar = createComponent({
  ...
  react: React,
  events: {
    onDsSelect: 'ds-select' as EventName<DsSelectEvent>,
    onDsNavigate: 'ds-navigate' as EventName<DsNavigateEvent>,
  },
});
